...
public:
  SimpleQueryVisitor(SimpleRealMarking &marking,
                     const SimpleTimedArcPetriNet &tapn, int maxDelay)
...
private:
  bool compare(int numberOfTokensInPlace, AtomicProposition::op_e op,
               int n) const;
...
bool SimpleQueryVisitor::compare(int numberOfTokensInPlace,
                                 AtomicProposition::op_e op, int n) const {
